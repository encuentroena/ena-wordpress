    <?php
    /*
    Template Name: Archivo de Miembros
    */
    ?>
...
$feed->set_cache_location ('./wp-content/themes/ena-wordpress/cache/'); // Set the cache location
...
<a target="_blank" href="<?php echo $item->get_permalink(); ?>" class="news-memb-item">
		<div class="news-memb-fecha"><?php echo $item->get_date('d M y'); ?></div>
