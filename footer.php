				...
				<div class="espacio"></div>
					<div class="site-info">
						<div id="footer-image" style='background: url("/wp-content/themes/ena-wordpress/images/footer<?php
					$a=array("02","03","04","05","01");
					echo $a[array_rand($a)];
					?>.png") no-repeat scroll 0 0 rgba(0, 0, 0, 0);'></div>
